...
RecorderThread::RecorderThread(
    const Config* in_cfg, MacScheduler* mac_scheduler, size_t thread_id,
    int core, size_t queue_size, size_t antenna_offset, size_t num_antennas,
  ...
  for (const auto& worker_type : types) {
    workers_.emplace_back(RecorderWorker::Create(
        worker_type, in_cfg, mac_scheduler, antenna_offset, num_antennas,
